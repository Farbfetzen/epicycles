...
#         # FIXME: Make sure that the very fist frame shows the position
#         #  as straight up. When the app starts paused the circles should not
#         #  have moved.
#         if not self.paused:
#             if self.fade:
...
#
#     def erase_line(self):
#         self.line_surface.fill(constants.BACKGROUND_COLOR)
#
#     @staticmethod
#     def get_dist(p1, p2):
